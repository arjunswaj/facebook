		...
		<div style="overflow-y: scroll; height: 536px;">	
			...
			<table style="width: 96%; margin-left: 2%;">
				<tr>
					...
					<td align="right"><a href='deleteInvitation?listName=invited&eventId=<s:property value="eventId" />&inviteeId=<s:property value="#u.key" />'><input type="button" value="X" /></a></td>
				</tr>
			</table>
			<hr />
			</s:iterator>
