			...
			<table style="width: 96%; margin-left: 2%;">
				<tr>
					...
					<td align="right">
						...
						<a style="text-decoration: none;" href='deleteInvitation?listName=invited&eventId=<s:property value="eventId" />&inviteeId=<s:property value="#u.key" />'><input type="button" value="X" /></a>
						</s:if>
					</td>
				</tr>
			</table>
