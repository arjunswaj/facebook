	...
	<div style="position: absolute; width: 1500px; left: 700px; top: 120px">
		...
		<form action="firstsignup" name="signupform"
			...
			<br> <input type="text" name="first_name"
				placeholder="First Name" size="21" style="height: 35px"> <input
				type="text" name="last_name" placeholder="Last Name" size="22"
				style="height: 35px"><br> <input type="text"
				name="email" placeholder="Your email address" size="50"
				style="height: 35px"><br> <input type="text"
				name="reemail" placeholder="Re-enter email address" size="50"
				style="height: 35px"> <br> <input type="password"
				name="password" placeholder="New Password" size="50"
				style="height: 35px"><br> <br> <label
				for="birthday">Birthday</label> <br> <select
				name="day">
			 ...
			 <input type="submit" value="Sign Up" style="height: 45px; width: 160px; background-color: #5CAD5C; color: white"> <br>
		</form>
	</div>
</body>
</html>
