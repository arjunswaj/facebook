...
<body>
	...
	<div class="col-md-4"  align="left" >
		...
		<table style="width:1000px" bgcolor="#FFFFFF">
		<tr>
  		<td bgcolor="#eeeff4" height="50" style="text-indent: 2em;"><b>   About </b></td>
  		</tr>
		<tr>
  		<td bgcolor="#FFFFFF" height="50" style="text-indent: 2em;"><b><s:property value="profession"/>&#160;at&#160;<font color="#3b5999"><s:property value="workplace"/></font></b></br> </td>
  		</tr>
  		<tr>
  		<td bgcolor="#FFFFFF" height="50" style="text-indent: 2em;"><b>Studied at <font color="#3b5999"><s:property value="school"/></font></b></br> </td>
  		</tr>
  		<tr>
  		<td  bgcolor="#FFFFFF" height="50" style="text-indent: 2em;"><b>Lives in <font color="#3b5999"><s:property value="currentplace"/></font></b></br> </td>
  		</tr>
  		<tr>
  		<td bgcolor="#FFFFFF" height="50" style="text-indent: 2em;"><b>From <font color="#3b5999"><s:property value="nativeplace"/></font></b></br> </td>
  		</tr>
  		</table>
  		</div>
  		<br/>
   ...
   <div class="col-md-5" style="background-color:#f7f7f7" align="left">
		...
		<form id="timelineform" action="timelineupdate" class="status-form">
			<div align="left">
				<s:textarea name="wallpost" cols="75" rows="5" id="timelineUpdate"
					placeholder="Write something..." style="width: 200%;" />
			</div>
			<div style="width:200%; text-align: right;">
				<s:submit value="Post" />
			</div>
	...
	<div id="feeds" align="right">
		...
		<br/>
		<br/>
		<div style="background-color:#FFFFFF;border-width:4px;border-style:solid;border-color:#eeeff4 " >
			<div id='<s:property value="#feeds.postId"/>' class="feed-container" align="right">
										...
										html.push("<form id=\"commentForm_"+commentData.postId+"\" class=\"comment-form\" action=\"postcomment\" method=\"post\"> ");
											html.push("<div class=\"comment-form\">");
												html.push("<div> ");
													...
													html.push("placeholder=\"Post Comment\" style=\"width: 120%;\"></textarea> ");
													html.push("<input type=\"hidden\" name=\"postId\" value=\""+commentData.postId+"\" />");
												html.push("</div> ");
												html.push("<div style=\"width: 0%; text-align: right;\"> ");
	...
	$(document).on("submit", "#timelineform",
				function(event) {
					...
					posting.done(function(commentData) {
						...
						html.push("<div class=\"right-status\">");
							html.push("<div>");
								html.push("<div class=\"status-description\" align=\"left\">");
									html.push("<span class=\"fullname\"> ");
									html.push(commentData.fullName );
									html.push("</span> ");
									html.push(" ");
